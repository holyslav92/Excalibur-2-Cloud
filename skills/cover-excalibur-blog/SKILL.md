...
4. **Title zone sacred + PIL typography (HARD)** — модель **не пишет** заголовок/Wordstat/телефон. После PNG: `python3 scripts/excalibur_blog_cover_typography.py --article-dir "$ARTICLE"`. Заголовок слева, стикеры+телефон только в правом рейле 72–98%.
...
# Типографика ТОЛЬКО PIL (модель не пишет буквы)
