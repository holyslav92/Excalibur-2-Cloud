...
- **powerful** `gpt-6-astra` (`DEROUTER_POWERFUL_MODEL`): Writer, Sol (article prose only), Title
- **utility** `gpt-5.6-terra` (`DEROUTER_TERRA_MODEL`): Scout, Research synthesis, Description, Cover-text, Schema, Cover-scene
