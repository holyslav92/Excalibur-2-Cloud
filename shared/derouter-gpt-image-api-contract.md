...
Text (factory brain): `scripts/excalibur_blog_derouter_opus_chat.py` → `POST https://api.derouter.ai/openai/v1/chat/completions` (`claude-opus-5`). См. `shared/derouter-opus-brain-contract.md`.
