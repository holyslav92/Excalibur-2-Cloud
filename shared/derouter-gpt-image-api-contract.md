...
Text (Writer/Sol): `POST https://api.derouter.ai/openai/v1/chat/completions` (`claude-opus-5`). Long/thinking may use api-direct — see `shared/writer-model-contract.md`.
