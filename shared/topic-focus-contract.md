...
## Ядро тенанта The Риэлтор (ALLOW)

Кроме исторического AI-ядра шаблона, **этот тенант** публикует разборы сделок:

эскроу, ДДУ, ЕГРН, вторичка, новостройки Тюмени, ипотека, маткапитал, аванс,
аренда, доверенность, наследство, опека, риэлтор.

## Ядро шаблона (ALLOW — Cursor/AI, если тема про автоматизацию)
