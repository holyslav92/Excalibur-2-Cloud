...
Title, Description, Cover-text — **powerful tier** (`gpt-6-astra`) вместе с Writer/Sol.

Utility tier (`gpt-5.6-terra`) — Scout, Research, Schema, Cover-scene. См. brain contract.
