...
Соблюдай:
- news-casus, interlink, запреты composite disclaimer, TL;DR, bullets до первого H2
- лид 4–6 предложений, HIT casus+число, ~1400–1600 слов на полную статью, spine once, agency ending, comment magnet
- только новостройки Тюмень

HTML whitelist: h2, h3, p, b, i, a, ul, ol, li, table, tr, th, td, figure, img, div (CTA). **b** не strong, **i** не em.

Автор фактов: Святослав Шакин, The Риэлтор, Тюмень — kitchen-table русский.
