...
- `cover/quad-manifest.json`, `cover/cover-text.json` (gate PASS)
- `cover/cover-registry.json` — image_caption_builder PASS

## Canon

- hook: «В ДДУ обещали больше, чем построили»
- phone: +7 922 001 65 05
- meme_picks: disappointed_black_guy, long_cat (cover); expanding_brain, james_doakes, trollface (inlines)
- NO Wordstat strips on cover (manifest log only)
- light/bright developer acceptance office, mustard-blue shirt + beige vest, right-side comparison pose, anti-repeat motifs recorded
