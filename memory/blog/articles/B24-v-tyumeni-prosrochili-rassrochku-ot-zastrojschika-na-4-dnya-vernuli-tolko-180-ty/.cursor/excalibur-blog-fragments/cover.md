...
- hook: «Просрочили на четыре дня — квартира ушла»
- phone: +7 922 001 65 05
- meme_picks: confused_math_lady, long_cat (cover); james_doakes, this_is_fine_dog, wojak (inlines)
- NO Wordstat strips on cover (manifest log only)
- light/bright installment nook, cream shirt + suspenders, anti-repeat motifs recorded
