...
- **2026-08-29 B15 content-learner:** same METRIKA CREDENTIALS BLOCKER; post 9310 ingest skipped; B15 lessons recorded without behavioral signals (pdkp cluster, cover budget OCR escape, sol near wordcount cap).

### Durable fix needed before next run
- Добавить Yandex Metrika OAuth + counter id в Cloud Secrets.
- Повторить ingest после publish B06, B10 (post 9161), B11 (post 9230), B12 (post 9250) и B15 (post 9310) для post-publish behavioral baseline.
