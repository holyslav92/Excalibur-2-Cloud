...
- **2026-08-29 B13 content-learner:** same METRIKA CREDENTIALS BLOCKER; publish blocked (cover_qa FAIL, no wp_post_id); B13 lessons recorded without behavioral signals (cover budget phone+wordstat, adult_guardianship cluster).
